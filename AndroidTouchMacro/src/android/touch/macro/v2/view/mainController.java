...
public class mainController {
	...
	private void event_handle_action( ActionEvent e) {
		...
		if( obj instanceof Button) {
			...
			case "ID_BTN_SCRIPT_PLAY"				: break;
			case "ID_BTN_SCRIPT_NEXT_SCREEN"		: break;
			case "ID_BTN_SCRIPT_PREV_SCREEN"		: break;
			case "ID_BTN_SCRIPT_NEW"				: break;
			case "ID_BTN_SCRIPT_SAVE"				: break;
			case "ID_BTN_SCRIPT_LOAD"				: break;
			case "ID_BTN_DELAY_TIME"				: break;
			}
	...
	private void event_handle_mouse(MouseEvent e) {
		...
		if( obj instanceof Canvas ) {
			...
			case "cvScriptDisplay" 	: mouse_handler_script_display(e); break;
			}
		}
    }
	 ...
	 * @param e
	 */
	private void mouse_handler_script_display(MouseEvent e) {
