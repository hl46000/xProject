...
public class ApkMetaTranslator implements XmlStreamer {
    ...
    public void onStartTag(XmlNodeStartTag xmlNodeStartTag) {
        ...
        case "category" :
        	if( attributes.get("name").compareToIgnoreCase("android.intent.category.LAUNCHER") == 0 ) {
        		apkMeta.setLauncherActivityName( activity_name );
        	}
        	break;
        	
        case "activity" :
        	activity_name = attributes.get("name");
        	break;
