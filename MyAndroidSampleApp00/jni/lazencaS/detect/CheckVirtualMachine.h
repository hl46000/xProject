...
void CheckVirtualMachine(){
	...
	virtualMachine("/system/build.prop","ro.product.manufacturer",&findSearch[0]);
	virtualMachine("/system/build.prop","ro.product.model",&findSearch[0]);
	virtualMachine("/system/build.prop","ro.product.name",&findSearch[0]);
	virtualMachine("/system/build.prop","ro.product.device",&findSearch[0]);
